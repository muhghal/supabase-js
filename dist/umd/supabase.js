  ...
  (() => {
      ...
      s = {
                ...
                (h = function* () {
                  try {
                    ...
                    c &&
                      ...
                      (('undefined' != typeof Blob && c instanceof Blob) || c instanceof ArrayBuffer
                        ? ((l['Content-Type'] = 'application/octet-stream'), (h = c))
                        : 'string' == typeof c
                        ? ((l['Content-Type'] = 'text/plain'), (h = c))
                        : 'undefined' != typeof FormData && c instanceof FormData
                        ? (h = c)
                        : ((l['Content-Type'] = 'application/json'), (h = JSON.stringify(c))))
        ...
        765: (e, t, s) => {
          ...
          s.r(t),
            s.d(t, {
              ...
              AuthPKCEGrantCodeExchangeError: () => O,
            ...
            return JSON.parse(
              (function (e) {
                ...
                let s,
                  ...
                  h = '',
                  l = 0
                for (e = e.replace('-', '+').replace('_', '/'); l < e.length; )
                  (n = t.indexOf(e.charAt(l++))),
                    ...
                    64 != a && 0 != r && (h += String.fromCharCode(r)),
                    64 != c && 0 != i && (h += String.fromCharCode(i))
                return h
              })(s)
            )
          }
          ...
          async function R(e, t, s, r) {
            ...
            const o = null !== (i = null == r ? void 0 : r.query) && void 0 !== i ? i : {}
          ...
          class F {
            ...
            async signOut(e, t = 'global') {
              try {
                return (
                  await R(this.fetch, 'POST', `${this.url}/logout?scope=${t}`, {
            ...
            async inviteUserByEmail(e, t = {}) {
              try {
                ...
                if (v(e)) return { data: { user: null }, error: e }
                throw e
              }
            }
            async generateLink(e) {
              try {
                ...
                if (v(e)) return { data: { properties: null, user: null }, error: e }
                throw e
              }
            }
            async createUser(e) {
            ...
            async listUsers(e) {
              ...
              try {
                const c = { nextPage: null, lastPage: 0, total: 0 },
                  h = await R(this.fetch, 'GET', `${this.url}/admin/users`, {
                    headers: this.headers,
                    noResolveJson: !0,
                    query: {
                      page:
                ...
                const l = await h.json(),
                  ...
                  d =
                    null !==
                      (a =
                        null === (o = h.headers.get('link')) || void 0 === o
                          ? void 0
                          : o.split(',')) && void 0 !== a
                      ? a
                      : []
                return (
                  d.length > 0 &&
                    ...
                    (c.total = parseInt(u))),
                  { data: Object.assign(Object.assign({}, l), c), error: null }
                )
              } catch (e) {
                if (v(e)) return { data: { users: [] }, error: e }
                throw e
              }
            }
            async getUserById(e) {
            ...
            return (
              ...
              await globalThis.navigator.locks.request(
                ...
                async (r) => {
                  ...
                  z.debug && console.log('@supabase/gotrue-js: navigatorLock: acquired', e, r.name)
                  try {
                    return await s()
                  } finally {
                    z.debug &&
          ...
          class X {
            constructor(e) {
              ...
              ;(this.memoryStorage = null),
                ...
                (this.instanceID = X.nextInstanceID),
                (X.nextInstanceID += 1),
                this.instanceID > 0 &&
                  r() &&
                  console.warn(
              ...
              const s = Object.assign(Object.assign({}, V), e)
              if (
                ...
                (this.admin = new F({ url: s.url, headers: s.headers, fetch: s.fetch })),
                (this.url = s.url),
                (this.headers = s.headers),
                (this.fetch = a(s.fetch)),
                (this.lock = s.lock || Y),
                ...
                this.persistSession
                  ? s.storage
                    ...
                    : n()
                    ? (this.storage = B)
                    : ((this.memoryStorage = {}), (this.storage = J(this.memoryStorage)))
                  : ((this.memoryStorage = {}), (this.storage = J(this.memoryStorage))),
                r() && globalThis.BroadcastChannel && this.persistSession && this.storageKey)
              ) {
                try {
            ...
            _debug(...e) {
              return (
                this.logDebugMessages &&
                  this.logger(
                    `GoTrueClient@${this.instanceID} (${M}) ${new Date().toISOString()}`,
                    ...e
                  ),
                this
              )
            ...
            async signUp(e) {
              ...
              try {
                ...
                if ((await this._removeSession(), 'email' in e)) {
                  ...
                  if (!('phone' in e))
                    throw new E('You must provide either an email or phone number and a password')
                  {
              ...
              try {
                ...
                return r
                  ...
                  ? (s.session &&
                    ...
                    { data: { user: s.user, session: s.session }, error: r })
                  : { data: { user: null, session: null }, error: new T() }
              } catch (e) {
                if (v(e)) return { data: { user: null, session: null }, error: e }
                throw e
              }
            ...
            async _exchangeCodeForSession(e) {
              const t = await l(this.storage, `${this.storageKey}-code-verifier`),
                { data: s, error: r } = await R(
                  this.fetch,
                  'POST',
                  `${this.url}/token?grant_type=pkce`,
                  { headers: this.headers, body: { auth_code: e, code_verifier: t }, xform: I }
                )
              return (
            ...
            async signInWithIdToken(e) {
              ...
              try {
                const { options: t, provider: s, token: r, access_token: i, nonce: n } = e,
                  o = await R(this.fetch, 'POST', `${this.url}/token?grant_type=id_token`, {
                    headers: this.headers,
                    body: {
                      provider: s,
                      id_token: r,
              ...
              try {
                ...
                if ('phone' in e) {
                  const { phone: t, options: s } = e,
                    { data: o, error: a } = await R(this.fetch, 'POST', `${this.url}/otp`, {
                      headers: this.headers,
                      body: {
                        phone: t,
                ...
                throw new E('You must provide either an email or phone number.')
              } catch (e) {
                if (v(e)) return { data: { user: null, session: null }, error: e }
                throw e
              }
            ...
            async verifyOtp(e) {
              ...
              try {
                ...
                const { data: n, error: o } = await R(this.fetch, 'POST', `${this.url}/verify`, {
                  headers: this.headers,
            ...
            async _reauthenticate() {
              try {
                return await this._useSession(async (e) => {
                  ...
                  if (s) throw s
                  if (!t) throw new S()
                  const { error: r } = await R(this.fetch, 'GET', `${this.url}/reauthenticate`, {
                    headers: this.headers,
                    jwt: t.access_token,
                  })
              ...
              try {
                ...
                if ('email' in e) {
                  const { email: s, type: r, options: i } = e,
                    { error: n } = await R(this.fetch, 'POST', t, {
                      headers: this.headers,
                      body: {
                        email: s,
                        type: r,
                ...
                if ('phone' in e) {
                  const { phone: s, type: r, options: i } = e,
                    { data: n, error: o } = await R(this.fetch, 'POST', t, {
                      headers: this.headers,
                      body: {
                        phone: s,
                        type: r,
                ...
                throw new E('You must provide either an email or phone number and a type')
              } catch (e) {
                if (v(e)) return { data: { user: null, session: null }, error: e }
                throw e
              }
            ...
            async __loadSession() {
              ...
              try {
                let e = null
                const t = await l(this.storage, this.storageKey)
                if (
              ...
              try {
                return e
                  ...
                  : await this._useSession(async (e) => {
                      ...
                      if (i) throw i
                      return await R(this.fetch, 'GET', `${this.url}/user`, {
                        headers: this.headers,
                        jwt:
                          null !==
                            (s =
                              null === (t = r.session) || void 0 === t ? void 0 : t.access_token) &&
                          void 0 !== s
                            ? s
                            : void 0,
                        xform: L,
            ...
            async _setSession(e) {
              try {
                ...
                if (v(e)) return { data: { session: null, user: null }, error: e }
                throw e
              }
            }
            ...
            async _getSessionFromURL(e) {
              try {
                if (!r()) throw new j('No browser detected.')
                if ('implicit' === this.flowType && !this._isImplicitGrantFlow())
                  throw new j('Not a valid implicit grant flow url.')
                if ('pkce' == this.flowType && !e) throw new O('Not a valid PKCE flow url.')
                const t = o(window.location.href)
                if (e) {
                  if (!t.code) throw new O('No code detected.')
                ...
                if (!(n && c && a && l)) throw new j('No session defined in URL')
                ...
                if (v(e)) return { data: { session: null, redirectType: null }, error: e }
                throw e
              }
            }
            ...
            async _isPKCEFlow() {
              const e = o(window.location.href),
                t = await l(this.storage, `${this.storageKey}-code-verifier`)
              return !(!e.code || !t)
            }
            ...
            async _signOut({ scope: e } = { scope: 'global' }) {
              return await this._useSession(async (t) => {
                ...
                if (n) {
                  ...
                  if (t && (!b(t) || (404 !== t.status && 401 !== t.status))) return { error: t }
                }
                return (
                  'others' !== e &&
                    (await this._removeSession(),
            ...
            async _handleProviderSignIn(e, t) {
              const s = await this._getUrlForProvider(e, {
                redirectTo: t.redirectTo,
                scopes: t.scopes,
            ...
            async _recoverAndRefresh() {
              ...
              this._debug(t, 'begin')
              try {
                const s = await l(this.storage, this.storageKey)
            ...
            _persistSession(e) {
              return this._debug('#_persistSession()', e), h(this.storage, this.storageKey, e)
            }
            async _removeSession() {
              this._debug('#_removeSession()'), await u(this.storage, this.storageKey)
            }
            ...
            async _startAutoRefresh() {
              ...
              const e = setInterval(() => this._autoRefreshTokenTick(), W)
            ...
            async _autoRefreshTokenTick() {
              ...
              try {
                  ...
                  try {
                    ...
                    try {
                      return await this._useSession(async (t) => {
                        ...
                        const r = Math.floor((1e3 * s.expires_at - e) / W)
                        this._debug(
                ...
                if (!(e.isAcquireTimeout || e instanceof G)) throw e
            ...
            async _handleVisibilityChange() {
              if (
                ...
                !r() || !(null === window || void 0 === window ? void 0 : window.addEventListener))
              )
            ...
            async _enroll(e) {
              try {
                return await this._useSession(async (t) => {
                  ...
                  const { data: o, error: a } = await R(this.fetch, 'POST', `${this.url}/factors`, {
                    body: {
        ...
        189: (e, t, s) => {
                  ...
                  if (
                    (i &&
                      ...
                      (null === (r = null == i ? void 0 : i.details) || void 0 === r
                        ? void 0
                        : r.includes('Results contain 0 rows')) &&
                      ((i = null), (a = 200), (c = 'OK')),
          ...
          class c {
            ...
            upsert(
              e,
              { onConflict: t, ignoreDuplicates: s = !1, count: r, defaultToNull: i = !0 } = {}
            ) {
          ...
          const h = { 'X-Client-Info': 'postgrest-js/1.8.4' }
          class l {
            constructor(e, { headers: t = {}, schema: s, fetch: r } = {}) {
              ;(this.url = e),
                (this.headers = Object.assign(Object.assign({}, h), t)),
                (this.schemaName = s),
                (this.fetch = r)
            }
            from(e) {
            ...
            schema(e) {
              return new l(this.url, { headers: this.headers, schema: e, fetch: this.fetch })
            }
        ...
        73: (e, t, s) => {
            ...
            constructor(e, t) {
              ...
              this.channel._on(s.state, {}, (e) => {
                ...
                ;(this.joinRef = this.channel._joinRef()),
                  (this.state = g.syncState(this.state, e, t, s)),
                  this.pendingDiffs.forEach((e) => {
                    this.state = g.syncDiff(this.state, e, t, s)
                  }),
                  (this.pendingDiffs = []),
                  r()
              }),
                this.channel._on(s.diff, {}, (e) => {
                  ...
                  this.inPendingSyncState()
                    ...
                    : ((this.state = g.syncDiff(this.state, e, t, s)), r())
                }),
                this.onJoin((e, t, s) => {
          ...
          const m = (e, t, s = {}) => {
            ...
            y = (e, t, s, r) => {
              const i = t.find((t) => t.name === e),
                ...
                o = s[e]
              return n && !r.includes(n) ? v(n, o) : _(o)
            },
            v = (e, t) => {
              if ('_' === e.charAt(0)) {
          ...
          class P {
                    ...
                    .receive('ok', ({ postgres_changes: t }) => {
                      ...
                      if (
                        ...
                        for (let s = 0; s < i; s++) {
                          const i = r[s],
                            {
                              filter: { event: o, schema: a, table: c, filter: h },
                            } = i,
                            l = t && t[s]
                          if (
                            !l ||
                          ...
                          n.push(Object.assign(Object.assign({}, i), { id: l.id }))
                        }
            ...
            _trigger(e, t, s) {
              ...
              const n = e.toLocaleLowerCase(),
                { close: o, error: c, leave: h, join: l } = a
              if (s && [o, c, h, l].indexOf(n) >= 0 && s !== this._joinRef()) return
          ...
          class x {
            ...
            push(e) {
              ...
              if ((this.log('push', `${t} ${s} (${i})`, r), this.isConnected()))
            ...
            _onConnMessage(e) {
              this.decode(e.data, (e) => {
                ...
                ;((i && i === this.pendingHeartbeatRef) || s === (null == r ? void 0 : r.type)) &&
                  (this.pendingHeartbeatRef = null),
                  this.log(
                    'receive',
                    `${r.status || ''} ${t} ${s} ${(i && '(' + i + ')') || ''}`,
        ...
        752: (e, t, s) => {
              ...
              c(void 0, void 0, void 0, function* () {
                ...
                (l = function* () {
                  return 'undefined' == typeof Response
                    ? (yield Promise.resolve().then(s.t.bind(s, 743, 23))).Response
                    : Response
                }),
          ...
          class _ {
            ...
            uploadToSignedUrl(e, t, s, r) {
              return m(this, void 0, void 0, function* () {
                ...
                try {
                  let e
                  const t = Object.assign({ upsert: v.upsert }, r),
            ...
            createSignedUploadUrl(e) {
              return m(this, void 0, void 0, function* () {
                try {
                  ...
                  return { data: { signedUrl: i.toString(), path: e, token: n }, error: null }
                } catch (e) {
                  if (i(e)) return { data: null, error: e }
                  throw e
                }
          ...
          const b = { 'X-Client-Info': 'storage-js/2.5.4' }
          ...
          class k {
            ...
            listBuckets() {
              return w(this, void 0, void 0, function* () {
                try {
                  return {
                    data: yield f(this.fetch, `${this.url}/bucket`, { headers: this.headers }),
                    error: null,
                  }
                } catch (e) {
                  if (i(e)) return { data: null, error: e }
            ...
            getBucket(e) {
              return w(this, void 0, void 0, function* () {
                try {
                  return {
                    data: yield f(this.fetch, `${this.url}/bucket/${e}`, { headers: this.headers }),
                    error: null,
                  }
                } catch (e) {
                  if (i(e)) return { data: null, error: e }
        ...
        296: function (e, t, s) {
          ...
          t.default = class {
            constructor(e, t, s) {
              ...
              const v = (0, l.stripTrailingSlash)(e)
              ;(this.realtimeUrl = `${v}/realtime/v1`.replace(/^http/i, 'ws')),
                (this.authUrl = `${v}/auth/v1`),
                (this.storageUrl = `${v}/storage/v1`),
                (this.functionsUrl = `${v}/functions/v1`)
              const _ = `sb-${new URL(this.authUrl).hostname.split('.')[0]}-auth-token`,
                b = {
                  db: f,
                  realtime: g,
                  auth: Object.assign(Object.assign({}, p), { storageKey: _ }),
                  global: d,
                },
                w = (0, l.applySettingDefaults)(null != s ? s : {}, b)
              ;(this.storageKey =
                null !== (i = null === (r = w.auth) || void 0 === r ? void 0 : r.storageKey) &&
                void 0 !== i
                  ? i
                  : ''),
                (this.headers =
            ...
            _initSupabaseAuthClient(
              ...
              return new u.SupabaseAuthClient({
                url: this.authUrl,
                headers: Object.assign(Object.assign({}, h), a),
                storageKey: i,
                autoRefreshToken: e,
                persistSession: t,
                detectSessionInUrl: s,
          ...
          Object.defineProperty(t, '__esModule', { value: !0 }),
            ...
            (t.applySettingDefaults = function (e, t) {
              const { db: s, auth: r, realtime: i, global: n } = e,
                { db: o, auth: a, realtime: c, global: h } = t
              return {
    ...
    return (
      ...
      (i.t = function (s, r) {
        ...
        var o = {}
        e = e || [null, t({}), t([]), t(t)]
        for (var a = 2 & r && s; 'object' == typeof a && !~e.indexOf(a); a = t(a))
          Object.getOwnPropertyNames(a).forEach((e) => (o[e] = () => s[e]))
        return (o.default = () => s), i.d(n, o), n
      }),
      (i.d = (e, t) => {
        for (var s in t)
